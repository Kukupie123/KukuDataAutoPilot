...
export class PouchDbWorkspace {
    ...
    async getWorkspace(workspaceName: string): Promise<WorkspaceModel | undefined> {
        ...
        try {
            ...
            this.logger.log({
                msg: `Got workspace with id ${workspaceName}: ${JSON.stringify(ws)}`,
                func: this.getWorkspace
            });
            return ws;
        } catch (err: any) {
    ...
    async deleteWorkspace(workspaceName: string): Promise<boolean> {
        ...
        try {
            ...
            this.logger.log({
                msg: `Successfully deleted workspace with ID ${workspaceName}`,
                func: this.deleteWorkspace
            });
            return true;
        } catch (err: any) {
